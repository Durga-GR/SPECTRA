...
2. Make sure `space.jpg` is in the same folder as `app.py` (used as the background image).
...
5. Open the local URL Streamlit prints (usually `http://localhost:8501`) in your browser.
6. Choose a tab — **Text**, **Image**, or **Video** — upload/paste your content, and click **Analyze**.
